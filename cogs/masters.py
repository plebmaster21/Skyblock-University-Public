...
class Master(commands.Cog):
    ...
    async def checkreq(self, ctx, arg):
        ...
        if check == True and slayercheck == True and catacheck == True and sacheck == True:
            ...
            reqsmhm = f"""Slayer Req = 800k | Your Slayers **{temp}**
            Cata Req = Cata 30 | Your Cata **{temp1}**
            Skills Req = SA 35 | Your SA **{temp2}**"""
